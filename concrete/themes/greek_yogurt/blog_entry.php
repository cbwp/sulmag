	...
	<div id="main-content-container" class="grid_16">
		<div id="main-content-inner">
			...
			<div id="main-content-post-author">
				...
				<p><?php  echo t('Posted by:');?> <span class="post-author"><?php   echo $userName; ?> um <a href="<?php  $c->getLinkToCollection;?>"><?php  echo $c->getCollectionDatePublic('H:i')?> am <?php  echo $c->getCollectionDatePublic('d. F Y')?></a></span>
