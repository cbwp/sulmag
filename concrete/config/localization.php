...
$u = new User();
Config::getOrDefine('SITE_LOCALE', 'de_DE');
...
if (!defined('ENABLE_TRANSLATE_LOCALE_de_DE')) {
	define('ENABLE_TRANSLATE_LOCALE_DE_DE', false);
}
...
if (!defined('DATE_APP_GENERIC_MDYT_FULL')) {
	define('DATE_APP_GENERIC_MDYT_FULL', t('d. F Y \u\m H:i'));
}

if (!defined('DATE_APP_GENERIC_MDYT')) {
	define('DATE_APP_GENERIC_MDYT', t('d.m.Y \u\m H:i'));
}
...
if (!defined('DATE_APP_GENERIC_MDY')) {
	define('DATE_APP_GENERIC_MDY', t('d.m.Y'));
}

if (!defined('DATE_APP_GENERIC_MDY_FULL')) {
	define('DATE_APP_GENERIC_MDY_FULL', t('d. F Y'));
}

if (!defined('DATE_APP_GENERIC_T')) {
	define('DATE_APP_GENERIC_T', t('H:i'));
}

if (!defined('DATE_APP_GENERIC_TS')) {
	define('DATE_APP_GENERIC_TS', t('H:i'));
}
...
define('GUEST_GROUP_NAME', t('Besucher'));
define('REGISTERED_GROUP_NAME', t('Registrierte Benutzer'));
